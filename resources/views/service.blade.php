...
@section('content')
    <div class="home4-services-section">
        <div class="container-xl container-fluid">
            ...
            <div class="row g-4 justify-content-center" id="engineering">
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/maintenance1.jpg" width="500" height="auto">
                        </div>
                        <div class="services-content">
                            <h3><a href=""> Industrial Machines Maintenance
                                    and Service</a></h3>
                            <p>One of The Major Concerns of any
                                ...
                                Assembly Industries.We offer our Industrial Automation, Electrical
                                and Mechanical Expertise to program and
                                Upgrade automated systems, troubleshooting
                                Machine breakdowns and offering both our
                                electrical and mechanical experience to clear
                                as soon as possible, all issues in the machines
                                and allow the machines run as expected
                                ensuring little to no breakdowns to all our
                                customers. You can trust us to help you keep
                                your machine healthy and working in an
                                optimum state.</p>
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="300ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        ...
                        <div class="services-content">
                            ...
                            <p>One of the Key Players to the Optimum Efficiency and Effectiveness of any
                                ...
                                sensitive products.As Automation Eye Limited, we acknowledge that if this gap is closed,
                                then a factory can run even more effectively. It is our Mandate to offer
                                this solution to all our customers. We Train Industrial Automation from
                                beginner level to intermediate and advanced levels. Our Training Focus
                                is the Programming, Troubleshooting and Maintenance of
                                Programmable Logic Controllers (PLCs), Human Machine Interfaces
                                (HMIs), Industrial Networking and Communication Protocols,
                                Supervisory Control and Data Acquisition (SCADA) Systems, Variable
                                Frequency Drives (VFDs), Servo Motors, Instrumentation and
                                Calibration, Pneumatic and Hydraulic Systems.
                                In addition to this training, we also offer other trainings to our partners
                                that help their day to day machine running, like electrical
                                troubleshooting, mechanical and electrical maintenance technologies
                                and safe machine running principles and protocols. All these trainings
                                build the human resources to be skillful and effective, allowing our
                                partners to run the processes with a high value skillset.</p>
                            <div class="services-btn">
                                <a class="primary-btn5" href="">
                                    <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="200ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/supply.jpg" width="500" height="auto">
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="300ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/repairs.jpg" width="500" height="auto">
                        </div>
                        <div class="services-content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="200ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/upgrades.jpg" width="500" height="auto">

                        </div>
                        <div class="services-content">
                            <h3><a href="">Machine Installation, Commissioning,
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="300ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/panels.jpg" width="500" height="auto">
                        </div>
                        <div class="services-content">
                            <h3><a href=""> Electrical Panel Design, Fabrication,
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="200ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/safety2.jpg" width="500" height="auto">
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="200ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/smartaccess.jpg" width="500" height="auto">>
                ...
                <div class="col-lg-12 col-md-12 col-sm-10 wow animate fadeInUp" data-wow-delay="300ms"
                    ...
                    <div class="single-service-card magnetic-item">
                        <div class="icon">
                            <img src="solutions/websites.jpg" width="500" height="auto">>
                        </div>
                        <div class="services-content">
