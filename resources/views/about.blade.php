...
<section class="breadcrumbs">
                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            <span>About</span>
                            <h1>"Get To Know About {{env('APP_NAME')}}"</h1>
    ...
    <div class="home3-about-section sec-mar">
        <div class="container-fluid">
            <div class="row g-lg-4 gy-5" id="innovation">
                <div class="col-lg-9">
                    <div class="section-title-3 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <h2>Innovation Hub</h2>
                        <p>Pioneering advancements in Artificial Intelligence, Virtual Reality, and staying attuned to market trends.
                            Our team focuses on creating new designs and solutions to meet the evolving needs of the technological landscape.</p>
                    </div>
                    <div class="about-left">
                        ...
                        <div class="about-content wow animate fadeInUp" data-wow-delay="400ms"
                            data-wow-duration="1500ms">
                            <h2>Partnerships:</h2>
                            <p>Collaborating with government bodies and parastatals to provide impactful solutions to counties and government programs.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="choose-right-img magnetic-item">
                                <img class="img-fluid " src="logo.png" width="100" height="100" alt>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row  g-lg-4 gy-5">
                        <div class="col-lg-7">
                            <div class="choose-left-content">
                                ...
                                <h4>Symposiums and Conferences <br>
                                    <span>Since 2021.</span></h4>
                                <p>Engineering Symposiums:
Hosting symposiums, competitions, and fostering a global community for engineers to connect, showcase their work, and build collaborative relationships.</p>
                                <div class="sl">
                                    <h2>#1</h2>
                                </div>
                                <div class="about-btn">
                        ...
                        <div class="row g-lg-0 gy-5">
                            <div class="col-lg-3 col-sm-6 d-flex justify-content-center wow animate fadeInUp"
                                ...
                                <div class="single-counter">
                                    <div class="icon">
                                        <svg width="50" height="57" viewBox="0 0 50 57"
                                            xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="marque-wrap">
            <div class="marquee_text">
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-01.svg" alt>
                </div>
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-02.svg" alt>
                </div>
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-03.svg" alt>
                </div>
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-04.svg" alt>
                </div>
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-05.svg" alt>
                </div>
                <div class="single-client">
                    <img class="img-fluid" src="assets/img/home-4/client-01.svg" alt>
                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card3">
                                    ...
                                    <div class="testimonial-content">
                                        <p>“Integer purus odio, placerat nec rhoncus in, ullamcorper nec dolor. and
                                            utoor
