...
<body class="home-dark  tt-magic-cursor">
    ...
    <header class="header-area2 style-2">
        <div class="header-logo">
            <a href="index.html"><img alt="image" class="" src="logo.png" width="50" height="50"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="index.html"><img alt="image" src="logo.png" width="100" height="100"></a>
                </div>
            </div>
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children"><a href="">About</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                ...
                <div class="col-lg-4 col-sm-6 d-flex">
                    <div class="footer-widget">
                        ...
                        <div class="footer-contact mb-40">
                            ...
                            <a
                                href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#3b525d547b5e435a564b575e15585456"><span
                                    class="__cf_email__"
                                    data-cfemail="4128272e012439202c312d246f222e2c">[email&#160;protected]</span></a><br>
                            <a
                                href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#462f28202906353336362934326825292b"><span
                                    class="__cf_email__"
                                    data-cfemail="a1c8cfc7cee1d2d4d1d1ced3d58fc2cecc">[email&#160;protected]</span></a>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-btn-content">
                            <div class="copyright-area">
                                <p>©Copyright 2024 <a href="#">Automationeye</a> | Design By <a
